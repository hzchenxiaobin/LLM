...
```
假设线程 (ty=0) 和 (ty=1) 同时读取 column k：

优化前：
- ty=0: 访问 sA[0..7][k]，rows 0,8,16,24... 都映射到相同的 banks
- ty=1: 访问 sA[8..15][k]，与 ty=0 冲突

优化后：
- ty=0: 访问 rows 0-7，地址 0-28, 36-64, 72-100, 108-136
        banks: 0-7, 9-16, 18-25, 27-2
- ty=1: 访问 rows 8-15，地址 288-316, 324-352, ...
        banks: 8-15, 17-24, 26-1, 3-10

无重叠！所有访问都是 bank-conflict-free！
```
