...
║        │           │                       │           │              ║
║   ┌────┴────┐ ┌────┴────┐           ┌────┴────┐ ┌────┴────┐         ║
║   │temp[1]=4│ │temp[3]=7│           │temp[5]=5│ │temp[7]=9│ Level 3 ║
║   │  (3+1)  │ │  (7+0)  │           │  (4+1)  │ │  (6+3)  │         ║
║   └────┬────┘ └────┬────┘           └────┬────┘ └────┬────┘         ║
║        │           │                       │           │              ║
║   ┌────┴────┐ ┌────┴────┐           ┌────┴────┐ ┌────┴────┐         ║
...
║  d=2 (offset=1):                                                      ║
║                                                                       ║
║    temp[1] ← temp[3] = 0              temp[3] += temp[1] (old)        ║
║    temp[3] ← 0 + 11 = 11                                              ║
║                                                                       ║
║    temp[5] ← temp[7] = 11            temp[7] += temp[5] (old)       ║
║    temp[7] ← 11 + 11 = 22                                             ║
║                                                                       ║
