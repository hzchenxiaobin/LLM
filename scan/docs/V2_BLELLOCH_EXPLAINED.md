...
║      ┌────┴────┐                                            ┌────┴────┐║
║      │temp[3]=11│                                            │temp[7]=14│║
║      │(3+1+7+0) │ ← Level 3                                 │(4+1+6+3) │║
║      └────┬────┘                                            └────┬────┘║
║           │                                                      │    ║
║     ┌─────┴─────┐                                        ┌─────┴─────┐║
║     │           │                                        │           │║
║ ┌───┴───┐ ┌───┴───┐                                  ┌───┴───┐ ┌───┴───┐║
║ │temp[1]│ │temp[3]│                                  │temp[5]│ │temp[7]│║
║ │=4(3+1) │ │=7(7+0) │ ← Level 2                      │=5(4+1) │ │=9(6+3) │║
║ └───┬───┘ └───┬───┘                                  └───┬───┘ └───┬───┘║
║     │         │                                          │         │    ║
║ ┌───┴─┐ ┌───┴─┐ ┌─────┐ ┌─────┐                  ┌───┴─┐ ┌───┴─┐ ┌─────┐ ┌─────┐║
║ │[3]  │ │[1]  │ │[7]  │ │[0]  │                  │[4]  │ │[1]  │ │[6]  │ │[3]  │║
║ │temp[0]│temp[1]│temp[2]│temp[3]│ ← Level 1 (叶子) │temp[4]│temp[5]│temp[6]│temp[7]│║
║ └─────┘ └─────┘ └─────┘ └─────┘                  └─────┘ └─────┘ └─────┘ └─────┘║
║                                                                       ║
║  注意: 每个节点存储的是以该位置为右端点的区间和                        ║
║  - temp[1]=4 是 a0+a1 (索引0-1的和)                                    ║
║  - temp[3]=7 是 a2+a3 (索引2-3的和)                                    ║
║  - temp[3]=11 是 a0+a1+a2+a3 (索引0-3的和)                            ║
║                                                                       ║
║  每一层索引 (ai, bi) 计算:                                            ║
║  d=4:  ai=0,1,2,3  bi=1,3,5,7  (offset=1, 2*thid+1/2-1)             ║
║  d=2:  ai=1,5      bi=3,7      (offset=2)                             ║
║  d=1:  ai=3        bi=7        (offset=4)                             ║
║                                                                       ║
╚══════════════════════════════════════════════════════════════════════╝
